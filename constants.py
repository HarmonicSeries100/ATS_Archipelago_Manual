...
POPTRACKER_STATE_CHOSEN_SUFFIX = "_chosen"
POPTRACKER_VICTORY_STATE_SUFFIX = "_victory"
POPTRACKER_UNLOCK_ITEM_PREFIX = "unlock_"
POPTRACKER_UNLOCK_FT_ITEM_PREFIX = "unlock_ft_"
POPTRACKER_START_CITY_ITEM_PREFIX = "start_"

NUMBER_OF_ITEM_COLUMNS = 5
NUMBER_OF_OPTION_COLUMNS = 5